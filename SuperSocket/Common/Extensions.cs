...
namespace SuperSocket.ClientEngine
{
    public static class Extensions
    {
        ...
        public static string GetValue(this StringNameValueCollection collection, string key)
        {
            return GetValue(collection, key, string.Empty);
        }

        public static string GetValue(this StringNameValueCollection collection, string key, string defaultValue)
        {
